---
name: circleci
description: Inspect, watch, and debug CircleCI runs for the current project using the circleci CLI. Use when checking CI status, investigating a failed build, fetching job logs/artifacts/test results, watching a run after a push, or rerunning/triggering workflows.
---
